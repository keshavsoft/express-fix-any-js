...
The documentation portal contains detailed explanations for every stage of route generation.

| Guide | Description |
|-------|-------------|
| 📄 App.js Route Generation | Creates router imports and registers API routes. |
| 📄 Version Route Generation | Creates version-based routing such as `/v1`. |
| 📄 Table Route Generation | Generates table routes like `/doctors` and `/patients`. |
| 📄 Endpoint Generation | Generates GET, POST, PUT and DELETE endpoint methods. |
